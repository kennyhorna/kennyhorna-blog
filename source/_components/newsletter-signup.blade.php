<div class="flex justify-center lg:-mx-12 my-12 p-6 md:px-12 bg-gray-200 border border-gray-400 text-sm md:rounded shadow">
    ...
    <div id="mc_embed_signup">
        <form action='https://gmail.us20.list-manage.com/subscribe/post?u=debad11f81ac71ce66fb76850&amp;id=5ff0ec32ee' method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            <div id="mc_embed_signup_scroll">
                <h2>Subscríbete a mi blog</h2>
