...
<?php $__env->startSection('body'); ?>
    <div class="container w-full flex flex-col items-center justify-center px-4">
      <div class="max-w-4xl pt-4 md:pt-10">
        <h1>¡Hola &#128075;&#127995;!</h1>

        <img src="/assets/images/main/about-me.jpg"
             alt="Kenny Horna"
             class="flex rounded-full h-48 md:h-64 w-48 md:w-64 bg-contain mx-auto md:float-right my-6 md:ml-10 no-draggable border-2 border-gray-400 hover:shadow-lg"
        >
      ...
      <div class="flex mt-4 md:mt-10">
        ...
        <a href="https://www.linkedin.com/in/kennyhorna">
          <svg class="h-12 md:h-16 border-gray-400 border-2 rounded-full mx-2 md:mx-4 hover:shadow-lg cursor-pointer" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\HCK\Repositories\kennyhorna.com-legacy/source\acerca-de-mi.blade.php ENDPATH**/ ?>